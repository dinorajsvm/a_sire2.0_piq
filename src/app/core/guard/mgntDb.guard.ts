...
export class mgntdbGuard implements CanLoad {
  ...
  constructor(private _authService: AuthService, 
    ...
    private _snackBar: SnackbarService) {
      ...
      console.log("PIQ 02-11-2023 Pre-Inspection Questionnarie :) MK");
    }
  canLoad(
    route: Route,
  ...
  //     }
      ...
      if( this.mackToken == localStorage.getItem('accessToken') && (this.mackToken !=undefined || localStorage.getItem('accessToken') != undefined)) {
       return true;
      }
