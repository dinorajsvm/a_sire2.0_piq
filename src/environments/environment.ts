...
export const environment = {
  ...
  // apiUrl: "http://70.205.1.5:8080",
  // authUrl: "http://70.205.1.5:8080/auth/api/v1/mack/auth",
  ...
  // apiUrl: "https://macktesting.solverminds.net/managementDashboard/api/v1/mgntDb",
